...
namespace PowerLms.Data
{
    ...
    public class EsMbl : GuidKeyObjectBase
    {
        ...
        /// </summary>
        [Comment("费用描述")]
        public string MblFreight { get; set; }
        /// <summary>
        /// 装船日期。
        /// </summary>
        [Comment("装船日期")]
        ...
        /// </summary>
        [Comment("正本张数")]
        public int? MBLIssueNumber { get; set; }
        /// <summary>
        /// 签发人。
        /// </summary>
        [Comment("签发人")]
        [MaxLength(32)]
        public string MBLIssueMan { get; set; }
        /// <summary>
        /// 签发时间。
        /// </summary>
        [Comment("签发时间")]
        [Precision(3)]
        public DateTime? MBLIssueDate { get; set; }
        /// <summary>
        /// 签发地点。
        /// </summary>
        [Comment("签发地点")]
        [MaxLength(32)]
        public string MBLIssuePlace { get; set; }
        /// <summary>
        /// 放货方式。
        /// </summary>
        [Comment("放货方式")]
        ...
        /// </summary>
        [Comment("提单附页")]
        public string MBLRemark { get; set; }
    }
}
