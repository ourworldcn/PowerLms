...
namespace PowerLmsData.Migrations
{
    ...
    [Migration("20250724090528_25072401")]
    partial class _25072401
    {
            ...
            modelBuilder.Entity("PowerLms.Data.OA.OaExpenseRequisition", b =>
                {
                    ...
                    b.Property<DateTime?>("AuditDateTime")
                        .HasPrecision(3)
                        .HasColumnType("datetime2(3)")
                        .HasComment("审核时间。为空则表示未审核。审核通过后填写审核时间。");

                    b.Property<Guid?>("AuditOperatorId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("审核操作者Id。为空则表示未审核。");
                    ...
                    b.Property<string>("ExpenseCategory")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)")
                        .HasComment("费用种类，选择日常费用种类，申请的费用种类申请人填写，不关联科目代码");
                    ...
                    b.Property<bool>("IsImportFinancialSoftware")
                        .HasColumnType("bit")
                        .HasComment("是否导入财务软件，作为后期金蝶财务软件导入条件");
                    ...
                    b.Property<string>("RelatedCustomer")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)")
                        .HasComment("相关客户，字符串即可，不用从客户资料中选择");
            ...
            modelBuilder.Entity("PowerLms.Data.OA.OaExpenseRequisitionItem", b =>
                {
                    ...
                    b.Property<Guid?>("DepartmentId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("部门Id，选择系统中的组织架构部门，关联到PlOrganization的Id");
