...
namespace PowerLmsData.Migrations
{
    ...
    [Migration("20250722075608_25072201")]
    partial class _25072201
    {
            ...
            modelBuilder.Entity("PowerLms.Data.OA.OaExpenseRequisition", b =>
                {
                    ...
                    b.Property<Guid?>("BankAccountId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("银行账户Id，当结算方式是银行时选择本公司信息中的银行账户id，审批流程成功完成后通过单独结算接口处理");
                    ...
                    b.Property<byte?>("SettlementMethod")
                        .HasColumnType("tinyint")
                        .HasComment("结算方式，现金或银行转账，审批流程成功完成后通过单独结算接口处理");
            ...
            modelBuilder.Entity("PowerLms.Data.OA.OaExpenseRequisitionItem", b =>
                {
                    ...
                    b.Property<Guid>("DailyFeesTypeId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("日常费用种类Id，关联到DailyFeesType的Id");
