...
namespace PowerLmsData.Migrations
{
    ...
    [Migration("20240727052752_24072701")]
    partial class _24072701
    {
            ...
            modelBuilder.Entity("PowerLms.Data.PlIaDoc", b =>
                {
                    ...
                    b.Property<byte>("OperationalStatus")
                        .HasColumnType("tinyint")
                        .HasComment("操作状态。初始化单据（此时未经任何操作）=0,已调单=1,已申报=2,已出税=3,海关已放行=4,已入库=5,仓库已放行=6。");
            ...
            modelBuilder.Entity("PowerLms.Data.PlIsDoc", b =>
                {
                    ...
                    b.Property<byte>("Status")
                        .HasColumnType("tinyint")
                        .HasComment("操作状态。1=已换单,2=船已到港,4=卸货完成,8=已提货。");
            ...
            modelBuilder.Entity("PowerLms.Data.PlJob", b =>
                {
                    ...
                    b.Property<byte>("JobState")
                        .HasColumnType("tinyint")
                        .HasComment("工作状态。Operating正操作=2，Operated操作完成=4，Checked已审核=8，Closed已关闭=16.");
                    ...
                    b.Property<byte>("OperateState")
                        .HasColumnType("tinyint")
                        .HasComment("操作状态。NewJob初始=0,Arrived 已到货=2,Declared 已申报=4,Delivered 已配送=8,Submitted 已交单=16,Notified 已通知=32");
