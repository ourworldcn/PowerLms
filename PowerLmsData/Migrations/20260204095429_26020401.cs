...
{
    public partial class _26020401 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "ExesTYpe",
                table: "EaMawbOtherCharges",
                newName: "ExesCategory");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HawbId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "分单id"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EaHawbCubages", x => x.Id);
                },
                comment: "空运出口分单委托明细表");

            migrationBuilder.CreateTable(
                name: "EaHawbOtherCharges",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    HawbId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "分单id"),
                    ...
                    ExesCategory = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true, comment: "费用种类名称")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EaHawbOtherCharges", x => x.Id);
                },
                comment: "空运出口分单其他费用表");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HBLNo = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "分单号"),
                    BillStatus = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "分单状态"),
                    ...
                    CnrLinkKind = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true, comment: "发货人联系人类型"),
                    ...
                    CneLinkKind = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true, comment: "收货人联系人类型"),
                    ...
                    NtLinkKind = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: true, comment: "通知货人联系人类型"),
                    ...
                    FreightCategory = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true, comment: "服务等级"),
                    ...
                    RateCategory = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: true, comment: "运价等级"),
                    ...
                    PkgsKind = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "包装方式"),
                    MeasureMent = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false, comment: "体积"),
                    ...
                    ArrivalPkgsNum = table.Column<int>(type: "int", nullable: false, comment: "到货件数"),
                    ArrivalPlace = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "到货地"),
                    ArrivalDate = table.Column<DateTime>(type: "datetime2(3)", precision: 3, nullable: true, comment: "到货日期"),
                    ArrivalWeight = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false, comment: "到货重量"),
                    ArrivalCustom = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "申报地海关"),
                    CommodityItemNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, comment: "货物号"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EaHawbs", x => x.Id);
                },
                comment: "空运出口分单表");
        }
