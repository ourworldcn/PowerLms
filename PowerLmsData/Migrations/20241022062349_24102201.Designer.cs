...
namespace PowerLmsData.Migrations
{
    ...
    [Migration("20241022062349_24102201")]
    partial class _24102201
    {
            ...
            modelBuilder.Entity("PowerLms.Data.PlIaDoc", b =>
                {
                    ...
                    b.Property<byte>("Status")
                        .HasColumnType("tinyint")
                        .HasComment("操作状态。0=初始化单据但尚未操作，,已调单=1,已申报=2,已出税=4,海关已放行=8,已入库=16,仓库已放行=128。");
            ...
            modelBuilder.Entity("PowerLms.Data.PlInvoices", b =>
                {
                    ...
                    b.Property<bool>("DirectionOfIE")
                        .HasColumnType("bit")
                        .HasComment("收支方向。true=收入，false=支出(默认)。");
