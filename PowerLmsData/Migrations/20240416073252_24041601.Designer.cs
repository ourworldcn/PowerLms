...
namespace PowerLmsData.Migrations
{
    ...
    [Migration("20240416073252_24041601")]
    partial class _24041601
    {
            ...
            modelBuilder.Entity("PowerLms.Data.DocFeeRequisition", b =>
                {
                    ...
                    b.Property<decimal>("Amount")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)")
                        .HasComment("金额,可以不用实体字段，明细合计显示也行.");
            ...
            modelBuilder.Entity("PowerLms.Data.OwWfTemplateNode", b =>
                {
                    ...
                    b.Property<Guid?>("NextId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("下一个节点的Id。通常都是职员Id。遇特殊情况，工作流引擎自行解释。");

                    b.Property<Guid>("ParentId")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("流程Id");

                    b.Property<byte>("RejectOpertion")
                        .HasColumnType("tinyint");
